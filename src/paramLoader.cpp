...
paramHandler::paramHandler(const std::string settingPath)
{
    ...
    //-- 读取coarse部分的参数
    coarse.width = fsSettings["coarse.width"];
    coarse.height = fsSettings["coarse.height"];
    ...
    std::cout<<"\033[36m [paramHandler] \033[0m"<<"\033[33m[coarse] \033[0m" 
             <<"- WIDTH: " << coarse.width<<std::endl;
    std::cout<<"\033[36m [paramHandler] \033[0m"<<"\033[33m[coarse] \033[0m" 
             <<"- HEIGHT: " << coarse.height<<std::endl;
    std::cout<<"\033[36m [paramHandler] \033[0m"<<"\033[33m[coarse] \033[0m" 
    ...
    //-- 读取 windows 部分参数
    win.kf_rot_thres = fsSettings["win.kf_rot_thres"];
    win.kf_trans_thres = fsSettings["win.kf_trans_thres"];
    win.window_size = fsSettings["win.window_size"];
    win.window_step = fsSettings["win.window_step"];

    std::cout<<"\033[36m [paramHandler] \033[0m"<<"\033[35m[win] \033[0m" 
        <<"- kf_rot_thres: " << win.kf_rot_thres<<std::endl;
    std::cout<<"\033[36m [paramHandler] \033[0m"<<"\033[35m[win] \033[0m" 
        <<"- kf_trans_thres: " << win.kf_trans_thres<<std::endl;
    std::cout<<"\033[36m [paramHandler] \033[0m"<<"\033[35m[win] \033[0m" 
        <<"- window_size: " << win.window_size<<std::endl;
    std::cout<<"\033[36m [paramHandler] \033[0m"<<"\033[35m[win] \033[0m" 
        <<"- window_step: " << win.window_step<<std::endl;
